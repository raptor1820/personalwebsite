...
const mainSectionData = {
  ...
  details: [
    { label: 'Email', value: 'ritwicverma@gmail.com', url: 'mailto:ritwicverma@gmail.com' },
  ...
  pdfDetails: [
    ...
    { label: 'LinkedIn', value: 'ritwicverma', url: 'https://linkedin.com/in/ritwicverma' },
    { label: 'GitHub', value: 'raptor1820', url: 'https://github.com/raptor1820' },
    { label: 'Website', value: 'ritwic.com', url: 'https://ritwic.com', fullRow: true },
  ],
  ...
  // },
  links: [github({ url: 'https://github.com/raptor1820' }), linkedin({ url: 'https://linkedin.com/in/ritwicverma' })],

...
import { react, tailwindCss, flask, html, css, javascript, express, mongoDb, node, openai } from '../helpers/skills';
  ...
  projects: [
    {
      ...
      screenshots: [
        { src: import('@/assets/portfolio/bubblescreenshot1.png'), alt: 'First screenshot' },
        { src: import('@/assets/portfolio/bubblescreenshot2.png'), alt: 'Second screenshot' },
      ],
      description: `
      ...
      links: [
        ...
        website({ url: 'https://chromewebstore.google.com/detail/bubble-burst/gkhmlcaflnhgpdbjoancilhdngflcidn' }),
      ],
    },
    {
      name: 'CortX',
    ...
    },
    {
      ...
      description: 'Developed a Chrome extension that uses NLP to summarize emails and suggest replies.',
      tagsList: {
        title: 'Technologies',
